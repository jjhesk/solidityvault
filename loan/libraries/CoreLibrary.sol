...
library CoreLibrary {
    ...
    struct ReserveData {
        ...
        **/
        ...
        uint256 decimals;
        /**
        * @dev address of the fToken representing the asset
        **/
    ...
    * @param _self the reserve object
    * @param _fTokenAddress the address of the overlying atoken contract
    ...
    **/
    function init(
        ...
        require(_self.fTokenAddress == address(0), "Reserve has already been initialized");
        ...
        _self.fTokenAddress = _fTokenAddress;
