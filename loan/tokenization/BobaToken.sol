...
contract BobaToken is ERC20, ERC20Detailed {
    ...
    **/
    ...
    ) public ERC20Detailed("BobaToken", "BOBA", 18) {
    **/
    constructor(
    ...
    **/
    ...
    /**
    * @dev redeems fToken for the underlying asset
    ...
    **/
     ...
     * only lending pools can call this function
     * @param _account the address from which burn the fTokens
    ...
    /**
     * @dev transfers tokens in the event of a borrow being liquidated, in case the liquidators reclaims the fToken
     *      only lending pools can call this function
     * @param _from the address from which transfer the fTokens
    ...
    **/
    ...
    /**
    * @dev executes the transfer of fTokens, invoked by both _transfer() and
