...
contract LendingPoolLiquidationManager is ReentrancyGuard, VersionedInitializable {
    ...
    **/
    function liquidationCall(
        ...
        BobaToken collateralAtoken = BobaToken(core.getReserveATokenAddress(_collateral));

        //if liquidator reclaims the fToken, he receives the equivalent atoken amount
        if (_receiveAToken) {
