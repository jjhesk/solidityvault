...
contract LendingPoolCore is VersionedInitializable {
    ...
    * @param _balanceIncrease the accrued interest on the borrowed amount
    * @param _liquidatorReceivesAToken true if the liquidator will receive fTokens, false otherwise
    **/
    ...
    **/
    ...
    /**
    * @dev gets the underlying asset balance of a user based on the corresponding fToken balance.
    * @param _reserve the reserve address
    ...
    **/
    ...
    returns (uint256)
    {
        BobaToken fToken = BobaToken(reserves[_reserve].fTokenAddress);
    ...
    **/
    ...
    /**
    * @dev gets the fToken contract address for the reserve
    * @param _reserve the reserve address
    * @return the address of the fToken contract
    **/

    function getReserveATokenAddress(address _reserve) public view returns (address) {
        CoreLibrary.ReserveData storage reserve = reserves[_reserve];
        return reserve.fTokenAddress;
    }
    ...
    * @param _reserve the address of the reserve
    * @param _fTokenAddress the address of the overlying fToken contract
    ...
    **/
    function initReserve(
        ...
        reserves[_reserve].init(_fTokenAddress, _decimals, _interestRateStrategyAddress);
    ...
    **/
    ...
    external onlyLendingPoolConfigurator {
        ...
        reserves[lastReserve].fTokenAddress = address(0);
