...
contract LendingPoolConfigurator is VersionedInitializable {
    ...
    **/
    function initReserve(
        ...
        string memory fTokenName = string(abi.encodePacked("SWAP Interest bearing ", asset.name()));
        string memory fTokenSymbol = string(abi.encodePacked("a", asset.symbol()));
    ...
    /**
    * @dev initializes a reserve using fTokenData provided externally (useful if the underlying ERC20 contract doesn't expose name or decimals)
    * @param _reserve the address of the reserve to be initialized
    * @param _fTokenName the name of the fToken contract
    * @param _fTokenSymbol the symbol of the fToken contract
    * @param _underlyingAssetDecimals the decimals of the reserve underlying asset
    * @param _interestRateStrategyAddress the address of the interest rate strategy contract for this reserve
    **/
    function initReserveWithData(
        ...
        AToken fTokenInstance = new AToken(
