...
import "../tokenization/BobaToken.sol";
...
contract LendingPool is ReentrancyGuard, VersionedInitializable {
    ...
    * @param _receiveAToken true if the liquidator wants to receive fTokens, false otherwise
    * @param _timestamp the timestamp of the action
    **/
    ...
    **/
    modifier onlyOverlyingAToken(address _reserve) {
        require(
            ...
            "The caller of this function can only be the fToken contract of this reserve"
        );
        _;
    }
    ...
    **/
    ...
    /**
    * @dev deposits The underlying asset into the reserve. A corresponding amount of the overlying asset (fTokens)
    * is minted.
    * @param _reserve the address of the reserve
    * @param _amount the amount to be deposited
    ...
    **/
    ...
    {
        BobaToken fToken = BobaToken(core.getReserveATokenAddress(_reserve));

        bool isFirstDeposit = fToken.balanceOf(msg.sender) == 0;
    ...
    * This function is executed by the overlying fToken contract in response to a redeem action.
    * @param _reserve the address of the reserve
    ...
    **/
    function redeemUnderlying(
        ...
        uint256 _amount,
        uint256 _fTokenBalanceAfterRedeem
    )
    external
    nonReentrant
    ...
    onlyAmountGreaterThanZero(_amount)
    {
        ...
        core.updateStateOnRedeem(_reserve, _user, _amount, _fTokenBalanceAfterRedeem == 0);
    ...
    * this is regulated by governance to ensure that the protocol is not abused, and the user is paying a fair
    ...
    * @param _receiveAToken true if the liquidators wants to receive the fTokens, false if
